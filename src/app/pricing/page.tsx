  ...
  return (
    <main className="mx-auto max-w-5xl p-6 space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {/* One-time */}
        <div className="border rounded-lg bg-white p-6 flex flex-col justify-between shadow-sm hover:shadow-md transition">
          ...
          <div className="pt-4">
            <button
              ...
              className="w-full rounded-lg bg-blue-600 text-white py-2 hover:bg-blue-700 transition font-medium shadow-sm"
            >
              Buy One-Time Report
            </button>
          </div>
