    ...
    <main className="mx-auto max-w-4xl px-6 py-10 space-y-8">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="rounded-2xl border p-6 bg-white flex flex-col">
          ...
          <div className="mt-4">
            <div className="text-3xl font-bold">${ONE_TIME_PRICE_USD.toFixed(0)}</div>
            {applied && (
              <div className="text-sm text-green-700">After promo: ${oneTimeAfter.toFixed(2)}</div>
            )}
          </div>
          <button
        ...
        <div className="rounded-2xl border p-6 bg-white flex flex-col">
          ...
          <div className="mt-4">
            <div className="text-3xl font-bold">${ANNUAL_PRICE_USD.toFixed(0)}</div>
            {applied && (
              <div className="text-sm text-green-700">After promo: ${annualAfter.toFixed(2)}</div>
            )}
          </div>
          <button
            className="mt-6 rounded-lg bg-blue-600 text-white px-4 py-2 hover:bg-blue-700 disabled:opacity-50"
